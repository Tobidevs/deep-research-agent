...
class ReferenceDataset:
    """
    Configurable, dynamic dataset class for model evaluation.
    Allows easy addition and retrieval of datasets.
    """

    def __init__(self, preload_defaults: bool = True):
        """
        Initialize the in‑memory reference dataset.

        @param preload_defaults: When True, automatically load the
        built‑in conversation / criteria examples defined in this module.
        """
    ...
    def add_dataset(
        ...
        """
        Register a new reference example under a unique name.
        """
        self.datasets[name] = {
    ...
    def _load_default_examples(self) -> None:
        """
        Preload the default, hand‑crafted evaluation examples.
        """
        # These identifiers are stable handles that evaluation code can use.
        self.add_dataset("example_1", conversation_1, criteria_1)
        self.add_dataset("example_2", conversation_2, criteria_2)
